...
FinalLncKmerNum = []
ReadMyCsv(FinalLncKmerNum, 'FinalLncKmerNum.csv')
...
while counterP < 5:
    ...
    num2 = 0
    counter = 0
    while counter < len(FinalLncKmerNum):
        AllNodeMannerNum[int(FinalLncKmerNum[counter][0])].extend(FinalLncKmerNum[counter][1:])
        num2 = num2 + 1
        counter = counter + 1
    print(num2)
