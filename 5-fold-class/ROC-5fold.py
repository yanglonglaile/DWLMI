...
plt.plot(P, R, color='crimson',
         label=r'Only Attribute (AUC = %0.4f)' % (roc_auc),linestyle=':',
         lw=2, alpha=1)
...
plt.plot(P, R, color='gold',
         label=r'Only Behavior (AUC = %0.4f)' % (roc_auc),linestyle='-.',
         lw=2, alpha=1)
...
plt.plot(P, R, color='deepskyblue',
         label=r'Attribute+Behavior (AUC = %0.4f)' % (roc_auc),linestyle='-',
         lw=2, alpha=1)
...
plt.legend(bbox_to_anchor=(0.25, 0.25), fontsize='large')
