...
plt.plot(P, R, color='crimson',
         label=r'Only Attribute (AUPR = %0.4f)' % (0.7892),linestyle=':',
         lw=2, alpha=1)
#MyEnlarge(0, 0.7, 0.25, 0.25, 0.5, 0, 2, P, R, 2, color='black') #细节放大函数
...
plt.plot(P, R, color='gold',
         label=r'Only Behavior (AUPR = %0.4f)' % (0.8620),linestyle='-.',
         lw=2, alpha=1)
...
plt.plot(P, R, color='deepskyblue',
         label=r'Attribute+Behavior (AUPR = %0.4f)' % (0.8669),linestyle='-',
         lw=2, alpha=1)
...
#plt.legend(bbox_to_anchor=(0.75, 0.25), fontsize='large')
