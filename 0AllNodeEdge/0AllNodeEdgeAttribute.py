...
# PDisease
PDDisGeNETProteinDisease = []
ReadMyCsv(PDDisGeNETProteinDisease, "PDDisGeNETProteinDisease.csv")
print('PDDisGeNETProteinDisease[0]', PDDisGeNETProteinDisease[0])
...
AllEdge.extend(PDDisGeNETProteinDisease)
